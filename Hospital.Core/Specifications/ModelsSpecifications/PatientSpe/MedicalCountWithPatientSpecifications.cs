...
{
    public class MedicalCountWithPatientSpecifications : BaseSpecifications<MedicalHistory>
    {
        public MedicalCountWithPatientSpecifications(BASpecParams BSpec) : base(P =>
